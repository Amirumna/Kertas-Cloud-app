...
const blocked_region = ['IN', 'PK', 'DE', 'UK', 'RU', 'CN']; // add regional codes seperated by comma, eg. ['IN', 'US', 'PK']
const blocked_asn = ['']; // add ASN numbers from http://www.bgplookingglass.com/list-of-autonomous-system-numbers, eg. [16509, 12345]
const authConfig = {
  "siteName": "Kertas Kita Semua", // Website name
  ...
  "roots":[
    {
        "id": "1_yCFzAVw94nrgq46kcOjZrNH7mI7vaY1",
        "name": "Kertas",
...
const uiConfig = {
  ...
  "logo_link_name": "",
  "login_image": "", // Login page logo image
  ...
  "search_button_class": "btn btn-info", // https://getbootstrap.com/docs/5.0/components/buttons/#examples
  ...
  "contact_link": "https://error.com", // Link to Contact Button on Menu
  "copyright_year": "2050", // year of copyright, can be anything like 2015 - 2020 or just 2020
  "company_name": "The Bay Index", // Name next to copyright
  "company_link": "https://error.com", // link of copyright name
  ...
  "unauthorized_owner_link": "https://error.com", // Unauthorized Error Page Link to Owner
  "unauthorized_owner_email": "kertas@proton.me", // Unauthorized Error Page Owner Email
...
const player_config = {
  "player": "plyr", // videojs || plyr || dplayer || jwplayer
  "videojs_version": "8.5.3", // Change videojs version in future when needed.
  "plyr_io_version": "3.7.8",
  "jwplayer_version": "8.28.1"
}
...
<html>
   <head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-SDNXRMBJNW"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-SDNXRMBJNW');
    </script>
    <script src="https://cdn.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.min.js"></script>
    <link href="https://cdn.jsdelivr.net/npm/bootswatch@5.0.0/dist/${uiConfig.theme}/bootstrap.min.css" rel="stylesheet" crossorigin="anonymous">
    <style>a{color:${uiConfig.css_a_tag_color};}p{color:${uiConfig.css_p_tag_color};}</style>
...
async function handleRequest(request, event) {
  ...
  if (path == '/app.js') {
    const js = await fetch('https://raw.githubusercontent.com/Amirumna/Drive/main/src/app.js', {
      method: 'GET',
    })
